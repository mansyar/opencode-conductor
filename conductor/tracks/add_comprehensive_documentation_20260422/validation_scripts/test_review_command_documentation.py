#!/usr/bin/env python3
"""
Validation script for /conductor:review command documentation.

This script validates that the review command documentation follows the expected format
...
class ReviewCommandValidator:
    """Validator for review command documentation."""
    ...
    def validate_description(self):
        ...
        try:
            ...
            if "review" not in content.lower() and "completed" not in content.lower():
                self.warnings.append("Description may not clearly explain review functionality")
    ...
    def validate_syntax(self):
        ...
        try:
            ...
            if "/conductor:review" not in content:
    ...
    def run_all_validations(self):
        ...
        print("Running review command documentation validation...")
...
def main():
    ...
    # Get the path to the review command documentation
    script_dir = Path(__file__).parent
    documentation_path = script_dir.parent / "review_command_documentation.md"
    
    # Create validator and run validations
    validator = ReviewCommandValidator(documentation_path)
