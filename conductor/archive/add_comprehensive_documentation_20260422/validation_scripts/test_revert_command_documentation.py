#!/usr/bin/env python3
"""
Validation script for /conductor:revert command documentation.

This script validates that the revert command documentation follows the expected format
...
class RevertCommandValidator:
    """Validator for revert command documentation."""
    ...
    def validate_description(self):
        ...
        try:
            ...
            if "revert" not in content.lower() and "undo" not in content.lower():
                self.warnings.append("Description may not clearly explain revert functionality")
    ...
    def validate_syntax(self):
        ...
        try:
            ...
            if "/conductor:revert" not in content:
    ...
    def run_all_validations(self):
        ...
        print("Running revert command documentation validation...")
...
def main():
    ...
    # Get the path to the revert command documentation
    script_dir = Path(__file__).parent
    documentation_path = script_dir.parent / "revert_command_documentation.md"
    
    # Create validator and run validations
    validator = RevertCommandValidator(documentation_path)
